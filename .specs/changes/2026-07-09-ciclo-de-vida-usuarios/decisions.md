...
1. Casa "criada pelo usuario" sera inferida pelas memberships ativas em que ele possui `Role = Owner`.
2. Cancelamento proprio com casa propria nao remove dados imediatamente; a conta entra em
...
4. O bloqueio real de conta desativada ocorrera no backend por middleware/guard dedicado; o
