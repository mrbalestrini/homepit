...
mesmo quando ele não estiver marcado para exibição.
...
- O catálogo público mostra somente planos marcados para exibição, com exceção do plano
...
2. Filtrar o catálogo público e manter a exceção do plano efetivo autenticado.
...
- O catálogo público só exibe planos marcados, exceto o plano efetivo da conta autenticada
