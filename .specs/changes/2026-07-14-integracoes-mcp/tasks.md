...
- Backend: testes unitários para cursor e ETag; testes de integração existentes para os módulos e credenciais. OAuth e MCP continuam pendentes da próxima fatia.
