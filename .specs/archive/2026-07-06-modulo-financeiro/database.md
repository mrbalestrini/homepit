...
Adicionar o schema necessario ao financeiro preservando tenancy por space, autoria,
relacionamentos opcionais com núcleo/projeto e compatibilidade com o startup que aplica
...
- Nova tabela para categorias financeiras por space e FKs opcionais de categoria em
  recorrencias, lancamentos e compras de cartao.
- Novos indices e FKs opcionais para `cores` e `projects`.
...
- `apps/api/src/OrganizaClub.Infrastructure/Migrations/20260706120000_AddFinanceModule.cs`
...
- Usar `SetNull` em FKs opcionais para núcleo/projeto, autoria e vinculos derivados.
...
- FKs opcionais para projeto/núcleo precisam sobreviver a exclusoes desses modulos sem
  quebrar historico.
- Backfill das categorias padrao precisa cobrir spaces ja existentes sem depender de
