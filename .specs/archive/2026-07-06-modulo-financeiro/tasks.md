...
- [x] Adicionar entidades de dominio financeiro e atualizar `IOrganizaClubDbContext`.
- [x] Mapear o modulo financeiro no `OrganizaClubDbContext` e criar a migration manual.
...
- [x] Adicionar categorias financeiras por space com defaults, CRUD de personalizadas e seleção opcional em caixa, recorrências e compras de cartão.
