...
namespace OrganizaClub.Application.Institutional;
    ...
    TimeProvider timeProvider)
{
    ...
    private static InstitutionalPage CreateDefaultEntity()
    {
        ...
        {
            Slug = PageSlug,
            SeoTitle = "Organiza Club | Controle tranquilo para cuidar da vida",
            SeoDescription = "Seu espaço para organizar finanças, projetos, estudos, vida e muito mais.",
            BrandName = "Organiza Club",
            BrandTagline = "Um clube de organização.",
            HeroEyebrow = "Controle tranquilo",
            HeroTitle = "Clareza inteligente para cuidar da vida.",
            HeroDescription = "Seu espaço para organizar finanças, projetos, estudos, vida e muito mais.",
            PrimaryCtaLabel = "Entrar no clube",
            PrimaryCtaUrl = "/projects",
            BenefitsTitle = "Menos coisas soltas. Mais clareza do que importa.",
            BenefitsDescription = "Organize sua vida. Compartilhe o que fizer sentido. Um passo de cada vez.",
            StepsTitle = "Coisas diferentes que começam a se encaixar.",
            StepsDescription = "Um caminho simples para entender o que precisa de atenção e seguir com tranquilidade.",
            HighlightEyebrow = "Um clube de organização",
            HighlightTitle = "Coisas diferentes que começam a se encaixar.",
            HighlightDescription = "Finanças, projetos, estudos, vida e muito mais reunidos com contexto, clareza e espaço para compartilhar só o que fizer sentido.",
            FinalCtaTitle = "Pode respirar. Agora dá para enxergar tudo.",
            FinalCtaDescription = "Organize sua vida. Compartilhe o que fizer sentido. Um passo de cada vez.",
            FooterText = "Organize sua vida. Compartilhe o que fizer sentido. Um passo de cada vez.",
            HeroImageAlt = "Visão clara dos espaços, núcleos e projetos no Organiza Club",
            HighlightImageAlt = "Organização tranquila de diferentes áreas da vida"
        };
        ...
        [
            ...
            {
                Position = 0,
                Title = "Tudo encontra seu espaço",
                Description = "Reúna finanças, projetos, estudos e rotina sem perder o contexto do que importa."
            },
            new InstitutionalBenefit
            {
                Position = 1,
                Title = "Compartilhe quando fizer sentido",
                Description = "Convide pessoas e mantenha permissões claras para cada espaço."
            },
            new InstitutionalBenefit
            {
                Position = 2,
                Title = "Clareza para seguir",
                Description = "Veja o que precisa de atenção e avance um passo de cada vez."
            }
        ];
        ...
        [
            new InstitutionalStep
            {
                ...
                Description = "Comece pela área da vida que você quer enxergar melhor."
            },
            new InstitutionalStep
            {
                Position = 1,
                Title = "Reúna em núcleos e projetos",
                Description = "Agrupe assuntos relacionados em uma estrutura simples de navegar."
            },
            new InstitutionalStep
            {
                Position = 2,
                Title = "Cuide do próximo passo",
                Description = "Acompanhe atividades e compartilhe o que ajudar a rotina a fluir."
            }
        ];
    ...
    private static NormalizedInstitutionalPage ValidateAndNormalize(UpdateInstitutionalPageRequest request)
    {
        ...
        return new NormalizedInstitutionalPage(
            ...
            NormalizeCtaUrl(request.PrimaryCtaUrl),
    ...
    private static string NormalizeCtaUrl(string? value)
    {
        ...
        {
            throw new ValidationException("Informe um caminho interno ou link HTTP/HTTPS válido para o botão principal.");
        }
