          ...
          <div className="relative space-y-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">Projetos, prompts e operações da casa em um só lugar.</p>
              </div>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-3">
                <h1 className="font-display text-4xl leading-tight text-foreground sm:text-5xl">
                  Organize a base operacional da casa sem cair em uma interface genérica.
                </h1>
                <p className="max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
                  Estruture casas, universos, projetos e agora também um banco de prompts reutilizável com contexto e
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <HighlightCard
                ...
                description="Universos, projetos e prompts com hierarquia consistente."
              />
              <HighlightCard
